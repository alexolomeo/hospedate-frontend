...
const ConfirmationEmailStep: React.FC<Props> = ({
  lang = 'es',
  sendCode,
  finallyRegister,
  errorSendCode,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        {errorSendCode && (
          <div className="alert alert-error mt-4" data-testid="error-send-code">
            <span>{errorSendCode}</span>
          </div>
        )}
        {errorRegister && (
          <div className="alert alert-error mt-4" data-testid="error-register">
