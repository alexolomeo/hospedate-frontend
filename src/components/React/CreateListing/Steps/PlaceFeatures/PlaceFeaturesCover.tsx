...
export default function PlaceFeaturesCover({ lang = 'es' }: Props) {
    ...
    <section className="flex flex-col items-center gap-8 bg-[var(--color-base-100)] px-6 py-6 md:flex-row md:gap-20 md:px-0 md:py-0">
      ...
      <div className="flex flex-1 flex-col items-start justify-center gap-4">
        <span className="text-sm leading-5 font-semibold text-[var(--color-base-content)]">
          {translate(
            t,
            'createListing.wizardStepContent.placeFeaturesCover.stepLabel'
          )}
        </span>
        ...
        <h1 className="text-4xl leading-none font-bold text-[var(--color-base-content)] md:text-5xl">
          {translate(
            t,
            'createListing.wizardStepContent.placeFeaturesCover.title'
          )}
        </h1>
        ...
        <p className="text-base leading-6 font-normal text-[var(--color-neutral)]">
          {translate(
            t,
            'createListing.wizardStepContent.placeFeaturesCover.description'
          )}
        </p>
      </div>
      ...
      <div className="flex w-full flex-1 justify-center overflow-hidden">
        <div className="/* tope de ancho por breakpoint, evita que se haga gigante */ relative w-full max-w-[420px] overflow-hidden rounded-[20px] sm:max-w-[520px] md:max-w-[560px] lg:max-w-[600px] xl:max-w-[640px]">
          {!loaded && (
          ...
          <OptimizedImage
            src="/images/create-listing/place-features/cover.webp"
            alt="Hospedate"
